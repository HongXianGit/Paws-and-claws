<?php include_once "../headerAll.php"; ?>
    ...
    <section class="catalogue">
      <div class="directory"><a href="index.php">Home</a> > <a href="products.php">Products</a> > Cat</div>
      <h1>Cat's products</h1>
      <div class="container">
				<?php
          include_once "../includes/dbh.inc.php";
          $sql = "SELECT * FROM products WHERE product_name LIKE '%CAT%' OR product_name LIKE '%Cat%' OR product_name LIKE '%cat%' ORDER BY product_id;";
